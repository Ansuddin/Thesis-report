...
Concurrency is not supported in Paragon and has been identified as an area for future work \cite{paragonpaper}. The side effects that comes with concurrency are untested.
