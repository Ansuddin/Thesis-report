...
% Furthermore there exist different patient journal systems for each region in Denmark and a solution  borgerforslag
...
%The bulk of information on the journal system is extracted from newspaper articles hence there is a high uncertainty of how the system really works. Therefore many assumptions are made about the current system when programming the prototype.
